...
<script>
import { listTask, getTask, delTask, addTask, updateTask } from "@/api/ware/task";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ware/task/export', {
        ...this.queryParams
