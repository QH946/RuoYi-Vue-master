    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['coupon:price:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['coupon:price:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listPrice, getPrice, delPrice, addPrice, updatePrice } from "@/api/coupon/price";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('coupon/price/export', {
        ...this.queryParams
