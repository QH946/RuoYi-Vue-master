    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['coupon:ladder:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['coupon:ladder:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listLadder, getLadder, delLadder, addLadder, updateLadder } from "@/api/coupon/ladder";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('coupon/ladder/export', {
        ...this.queryParams
