    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['coupon:notice:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['coupon:notice:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listNotice, getNotice, delNotice, addNotice, updateNotice } from "@/api/coupon/notice";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('coupon/notice/export', {
        ...this.queryParams
