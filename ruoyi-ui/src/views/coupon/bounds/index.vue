    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['coupon:bounds:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['coupon:bounds:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listBounds, getBounds, delBounds, addBounds, updateBounds } from "@/api/coupon/bounds";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('coupon/bounds/export', {
        ...this.queryParams
