...
<script>
import { listAdv, getAdv, delAdv, addAdv, updateAdv } from "@/api/coupon/adv";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('coupon/adv/export', {
        ...this.queryParams
