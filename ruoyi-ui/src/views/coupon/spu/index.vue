...
<script>
import { listSpu, getSpu, delSpu, addSpu, updateSpu } from "@/api/coupon/spu";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('coupon/spu/export', {
        ...this.queryParams
