    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['order:setting:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['order:setting:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSetting, getSetting, delSetting, addSetting, updateSetting } from "@/api/order/setting";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('order/setting/export', {
        ...this.queryParams
