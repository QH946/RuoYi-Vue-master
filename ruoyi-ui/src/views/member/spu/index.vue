...
<script>
import { listSpu, getSpu, delSpu, addSpu, updateSpu } from "@/api/member/spu";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('member/spu/export', {
        ...this.queryParams
