...
<script>
import { listLog, getLog, delLog, addLog, updateLog } from "@/api/member/log";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('member/log/export', {
        ...this.queryParams
